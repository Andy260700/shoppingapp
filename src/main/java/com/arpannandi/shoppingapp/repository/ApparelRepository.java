...
//    List<Apparel> findByBrand(String brand);
    HashSet<Apparel> findByNameContaining(String infix);
    HashSet<Apparel> findByCategoryContaining(String infix);
    HashSet<Apparel> findByBrand(String brand);
//    List<Apparel> findByNameContainingOrCategoryContainingOrBrandContaining(String infix);
